function initCanvas(){
    ...
    backgroundImage.src = "images/background-pic1.jpg"; //Background picture
    naveImage.src       = "images/cohete.png"; //Spaceship picture
    // Enemigos fotos
    enemiespic1.src     = "images/enemigo4.png";
    enemiespic2.src     = "images/enemigo5.png"; //Enemies picture
    
    // width and height (canvas)
    var cW = ctx.canvas.width; // 800px 
    ...
    // Para reducir una función repetitiva o dos, he realizado algunos cambios ligeros en cómo se crean los enemigos.
    var enemies = [
    ...
    // También obliga a los enemigos a comprobar si ELLOS están golpeando al jugador.
    ...
    function Launcher(){
        ...
        // Si deseas usar diferentes fuentes o mensajes para cuando el jugador pierde, puedes cambiarlo según sea necesario.
         this.gameStatus = {
            over: false, 
            message: "",
            fillStyle: '#49BFBF',
            font: "36px 'Inconsolata', monospace",
        }
        ...
        this.render = function () {
            ...
            if (enemies.length === 0) {
                ...
                ctx.fillStyle = '#49BFBF'; // Cambiar el color del texto a verde azulado
                ctx.font = "36px 'Inconsolata', monospace"; // Cambiar la fuente del texto a Inconsolata
        ...
        this.hitDetectLowerLevel = function(enemy){
            ...
            if(enemy.y > 550){
                ...
                this.gameStatus.message = 'Enemigo(s) han pasado';
            }
            ...
            // a) Si la posición "y" del enemigo es mayor que this.y - 25 => entonces sabemos que hay una colisión.
            // b) Si la posición "x" del enemigo es menor que this.x + 45 && la posición "x" del enemigo es mayor que this.x - 45 => entonces sabemos que hay una colisión.
